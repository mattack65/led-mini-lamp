...
Estimated costs are approximate, exclude shipping, and use EUR. AliExpress
prices and availability vary by destination and over time.
...
| Addressable LED strip | 1 | 35 LEDs; 60 LEDs/m; WS2812B ECO; IP30 | Under €2.00 | Tested: BTF-LIGHTING WS2812B ECO. The 60 LEDs/m spacing is required. 35 LEDs use about 60 cm of strip. ECO LEDs keep the full-white load suitable for ordinary USB power. [Find the exact specification on AliExpress](https://www.aliexpress.com/w/wholesale-ws2812b-eco-60-leds-m-ip30.html?SearchText=WS2812B%20ECO%2060%20LEDs%2Fm%20IP30) |
...
| Double-sided VHB tape | About 2 cm² | Suitable for electronics | ~€0.05 | Holds the ESP32 to the base. |
